...
lsi_model.print_topics(num_topics=2, num_words=5) # 打印各topic的含义[(0, '0.040*"system" + 0.039*"interface" + 0.038*"graph"'), (1, '0.046*"survey" + 0.036*"time" + 0.036*"response"')]
pprint(nodes)
print('--------------------------\n')
